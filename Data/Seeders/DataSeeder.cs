    ...
    public static async Task SeedDataAsync(IServiceProvider serviceProvider)
    {
        ...
        if (!context.Artists.Any())
        {
            var artists = new List<Artist>
            {
                ...
                new Artist { Name = "The Cassette" }, new Artist { Name = "Lý Bực" }, new Artist { Name = "The Flob" },
                new Artist { Name = "CHIN" }, new Artist { Name = "Vũ." }, new Artist { Name = "Hoàng Dũng" },
        ...
        if (!context.Products.Any())
        {
            ...
            var products = new List<Product>
            {
                new Product {
                    ...
                    Price = 1150000m, Quantity = 5, IsPublished = true,
                    Country = "US", ReleaseYear = 2013, Condition = "Sealed (Mới)",
                    ...
                    Images = new List<ProductImage> {
                        new ProductImage { Url = "/images/products/Nirvana/Nevermind/c1.jpg", IsPrimary = true, DisplayOrder = 1 },
                        new ProductImage { Url = "/images/products/Nirvana/Nevermind/c2.jpg", IsPrimary = false, DisplayOrder = 2 },
                        new ProductImage { Url = "/images/products/Nirvana/Nevermind/c3.jpg", IsPrimary = false, DisplayOrder = 3 },
                        new ProductImage { Url = "/images/products/Nirvana/Nevermind/c4.jpg", IsPrimary = false, DisplayOrder = 4 },
                        new ProductImage { Url = "/images/products/Nirvana/Nevermind/c5.jpg", IsPrimary = false, DisplayOrder = 5 }
                    }
                },
                ...
                new Product {
                    ...
                    Price = 1050000m, Quantity = 3, IsPublished = true,
                    Country = "US", ReleaseYear = 2017, Condition = "Sealed (Mới)",
                    Artist = metallica, Brand = blackened, Category = vinyl, Genre = rock, Style = sThrash,
                    Tracklist = "Side One:\n1. Battery\n2. Master Of Puppets\n3. The Thing That Should Not Be\n4. Welcome Home (Sanitarium)\n\nSide Two:\n1. Disposable Heroes\n2. Leper Messiah\n3. Orion\n4. Damage, Inc.",
                    Images = new List<ProductImage> {
                        new ProductImage { Url = "/images/products/Metallica/MasterOfPuppets/c1.jpg", IsPrimary = true, DisplayOrder = 1 },
                        new ProductImage { Url = "/images/products/Metallica/MasterOfPuppets/c2.jpg", IsPrimary = false, DisplayOrder = 2 },
                        new ProductImage { Url = "/images/products/Metallica/MasterOfPuppets/c3.jpg", IsPrimary = false, DisplayOrder = 3 },
                        new ProductImage { Url = "/images/products/Metallica/MasterOfPuppets/c4.jpg", IsPrimary = false, DisplayOrder = 4 },
                        new ProductImage { Url = "/images/products/Metallica/MasterOfPuppets/c5.jpg", IsPrimary = false, DisplayOrder = 5 }
                    }
                },
                ...
                new Product {
                    ...
                    Price = 1450000m, Quantity = 1, IsPublished = true,
                    Country = "Japan", ReleaseYear = 1976, Condition = "VG+ (Rất tốt)", IsUsed = true,
                    Artist = beatles, Brand = appleRec, Category = vinyl, Genre = rock, Style = sClassicRock,
                    Tracklist = "Side 1:\n1. Come Together\n2. Something\n3. Maxwell's Silver Hammer\n4. Oh! Darling\n5. Octopus's Garden\n6. I Want You (She's So Heavy)\n\nSide 2:\n1. Here Comes The Sun\n2. Because\n3. You Never Give Me Your Money\n4. Sun King\n5. Mean Mr. Mustard\n6. Polythene Pam\n7. She Came In Through The Bathroom Window\n8. Golden Slumbers\n9. Carry That Weight\n10. The End",
                    Images = new List<ProductImage> {
                        new ProductImage { Url = "/images/products/TheBeatles/AbbeyRoad/c1.jpg", IsPrimary = true, DisplayOrder = 1 },
                        new ProductImage { Url = "/images/products/TheBeatles/AbbeyRoad/c2.jpg", IsPrimary = false, DisplayOrder = 2 },
                        new ProductImage { Url = "/images/products/TheBeatles/AbbeyRoad/c3.jpg", IsPrimary = false, DisplayOrder = 3 },
                        new ProductImage { Url = "/images/products/TheBeatles/AbbeyRoad/c4.jpg", IsPrimary = false, DisplayOrder = 4 },
                        new ProductImage { Url = "/images/products/TheBeatles/AbbeyRoad/c5.jpg", IsPrimary = false, DisplayOrder = 5 }
                    }
                },
                ...
                new Product {
                    ...
                    Price = 1350000m, Quantity = 0, IsPublished = true,
                    Country = "US", ReleaseYear = 2020, Condition = "Sealed (Mới)",
                    Artist = linkinPark, Brand = warnerUs, Category = vinyl, Genre = rock, Style = sNuMetal,
                    Tracklist = "Side 1:\n1. Papercut\n2. One Step Closer\n3. With You\n4. Points Of Authority\n5. Crawling\n6. Runaway\n\nSide 2:\n1. By Myself\n2. In The End\n3. A Place For My Head\n4. Forgotten\n5. Cure For The Itch\n6. Pushing Me Away",
                    Images = new List<ProductImage> {
                        new ProductImage { Url = "/images/products/LinkinPark/HybridTheory/c1.jpg", IsPrimary = true, DisplayOrder = 1 },
                        new ProductImage { Url = "/images/products/LinkinPark/HybridTheory/c2.jpg", IsPrimary = false, DisplayOrder = 2 },
                        new ProductImage { Url = "/images/products/LinkinPark/HybridTheory/c3.jpg", IsPrimary = false, DisplayOrder = 3 },
                        new ProductImage { Url = "/images/products/LinkinPark/HybridTheory/c4.jpg", IsPrimary = false, DisplayOrder = 4 },
                        new ProductImage { Url = "/images/products/LinkinPark/HybridTheory/c5.jpg", IsPrimary = false, DisplayOrder = 5 }
                    }
                },
                ...
                new Product {
                    ...
                    Price = 390000m, Quantity = 20, IsPublished = true,
                    Country = "Việt Nam", ReleaseYear = 2022, Condition = "Sealed (Mới)",
                    Artist = ngot, Brand = lpClubBrand, Category = cd, Genre = pop, Style = sIndiePop,
                    Tracklist = "1. Bạn thỏ TV nhỏ\n2. Mấy khi\n3. Em trang trí\n4. Điểm đến cuối cùng\n5. Em trong đầu\n6. Chào buổi sáng\n7. Thấy chưa\n8. Đá tan\n9. Đêm hôm qua\n10. Gieo\n11.  Mất tích",
                    Images = new List<ProductImage> {
                        new ProductImage { Url = "/images/products/Ngot/Gieo/c1.jpg", IsPrimary = true, DisplayOrder = 1 },
                        new ProductImage { Url = "/images/products/Ngot/Gieo/c2.jpg", IsPrimary = false, DisplayOrder = 2 },
                        new ProductImage { Url = "/images/products/Ngot/Gieo/c3.jpg", IsPrimary = false, DisplayOrder = 3 }
                    }
                },
                ...
                new Product {
                    ...
                    Price = 390000m, Quantity = 10, IsPublished = true,
                    Country = "Việt Nam", ReleaseYear = 2024, Condition = "Sealed (Mới)",
                    ...
                    Images = new List<ProductImage> {
                        new ProductImage { Url = "/images/products/Vu/BaoTangCuaNuoiTiec/c1.jpg", IsPrimary = true }
                    }
                },
                ...
                new Product {
                    ...
                    Price = 350000m, Quantity = 15, IsPublished = true,
                    Country = "Việt Nam", ReleaseYear = 2021, Condition = "Sealed (Mới)",
                    ...
                    Images = new List<ProductImage> {
                        new ProductImage { Url = "/images/products/Chillies/QuaKhungCuaSo/c1.jpg", IsPrimary = true,  DisplayOrder = 1 },
                        new ProductImage { Url = "/images/products/Chillies/QuaKhungCuaSo/c2.jpg", IsPrimary = false, DisplayOrder = 2 }
                    }
                },
                ...
                new Product {
                    ...
                    Price = 390000m, Quantity = 100, IsPublished = true,
                    Country = "Việt Nam", ReleaseYear = 2025, Condition = "Sealed (Mới)",
                    IsPreOrder = true,
                    ReleaseDate = new DateTime(2025, 12, 20),
                    Artist = chillies, Brand = warnerVN, Category = cd, Genre = pop, Style = sVPop,
                    Tracklist = "1. Bao nhiêu\n2. Em đừng khóc\n3. Giá như\n4. Ms. May (ft. Magazine)\n5. Vùng ký ức\n6. Mộng du\n7. Qua khung cửa sổ\n8. Một cái tên (ft. Orange)\n9. Mascara\n10. Đường chân trời",
                    Images = new List<ProductImage> {
                        new ProductImage { Url = "/images/products/Chillies/KIM/c1.jpg", IsPrimary = true,  DisplayOrder = 1 },
                        new ProductImage { Url = "/images/products/Chillies/KIM/c2.jpg", IsPrimary = false, DisplayOrder = 2 },
                        new ProductImage { Url = "/images/products/Chillies/KIM/c3.jpg", IsPrimary = false, DisplayOrder = 3 },
                        new ProductImage { Url = "/images/products/Chillies/KIM/c4.jpg", IsPrimary = false, DisplayOrder = 4 }
                    }
                },
                ...
                new Product {
                    ...
                    Price = 280000m, Quantity = 10, IsPublished = true,
                    Country = "Việt Nam", ReleaseYear = 2021, Condition = "Sealed (Mới)",
                    Artist = theCassette, Brand = lpClubBrand, Category = cassette, Genre = rock, Style = sIndieRock,
                    Tracklist = "1. Cá rô\n2. Vùng đất linh hồn\n3. Nắng\n4. Espresso\n5. Ánh đèn phố\n6. Khoảng cách\n7. Nếu ngày mai tôi không trở về\n8. Tựa đêm nay\n9. Interlude: 9:00 PM\n10. Rừng đom đóm",
                    Images = new List<ProductImage> {
                        new ProductImage { Url = "/images/products/TheCassette/RungDomDom/c1.jpg", IsPrimary = true, DisplayOrder =1 },
                        new ProductImage { Url = "/images/products/TheCassette/RungDomDom/c2.jpg", IsPrimary = false, DisplayOrder = 2 },
                        new ProductImage { Url = "/images/products/TheCassette/RungDomDom/c3.jpg", IsPrimary = false, DisplayOrder = 3 }
                    }
                },
                ...
                new Product {
                    ...
                    Price = 220000m, Quantity = 5, IsPublished = true,
                    Country = "Việt Nam", ReleaseYear = 2019, Condition = "Sealed (Mới)",
                    ...
                    Images = new List<ProductImage> {
                        new ProductImage { Url = "/images/products/CaHoiHoang/HieuUngTronChay/c1.jpg", IsPrimary = true }
                    }
                },
                ...
                new Product {
                    ...
                    Price = 450000m, Quantity = 2, IsPublished = true,
                    Country = "US", ReleaseYear = 1993, Condition = "VG+ (Tốt)", IsUsed = true,
                    Artist = nirvana, Brand = geffen, Category = cassette, Genre = rock, Style = sGrunge,
                    Tracklist = "Side 1:\n1. Serve The Servants\n2. Scentless Apprentice\n3. Heart-Shaped Box\n4. Rape Me\n5. Frances Farmer Will Have Her Revenge On Seattle\n6. Dumb\n\nSide 2:\n1. Very Ape\n2. Milk It\n3. Pennyroyal Tea\n4. Radio Friendly Unit Shifter\n5. Tourette's\n6. All Apologies",
                    Images = new List<ProductImage> {
                        new ProductImage { Url = "/images/products/Nirvana/InUtero/c1.jpg", IsPrimary = true, DisplayOrder = 1 },
                        new ProductImage { Url = "/images/products/Nirvana/InUtero/c2.jpg", IsPrimary = false, DisplayOrder = 2 },
                        new ProductImage { Url = "/images/products/Nirvana/InUtero/c3.jpg", IsPrimary = false, DisplayOrder = 3 },
                        new ProductImage { Url = "/images/products/Nirvana/InUtero/c4.jpg", IsPrimary = false, DisplayOrder = 4 },
                        new ProductImage { Url = "/images/products/Nirvana/InUtero/c5.jpg", IsPrimary = false, DisplayOrder = 5 }
                    }
                }
            };
